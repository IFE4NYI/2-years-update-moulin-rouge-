...
select increment_id, product_name, price, qty, 
...
select count(*)
from new_order
where product_name like'%goat cury%'
...
when product_name like '%grant 12%' then 'Whisky'
...
when product_name like '%barcardi%' then 'Tequila'
...
when product_name like '%JW Red Label shot%' then 'Shot'

when product_name like '%The Islands iced tea%' then 'Classic Cocktail'
when product_name like '%Pinnacolada%' then 'Classic Cocktail'
...
when product_name like '%Graduator%' then 'Classic Cocktail'
when product_name like '%Tom Colling%' then 'Classic Cocktail'
when product_name like '%Classic Cheladda%' then 'Classic Cocktail'
when product_name like '%fizzy%' then 'Classic Cocktail'
when product_name like '%Flaming Doctor Pepper%' then 'Classic Cocktail'

when product_name like '%chappman%' then 'Mocktail'
when product_name like '%Side Chickky%' then 'Mocktail'
when product_name like '%monin%' then 'Mocktail'
when product_name like '%virgin%' then 'Mocktail'
when product_name like '%Beach Sunrise%' then 'Mocktail'

when product_name like '%milkshake%' then 'Milkshake'

when product_name like '%lagos%' then 'Smoothie'
when product_name like '%Peach Malooda%' then 'Smoothie'
when product_name like '%fixxzy%' then 'Smoothie'
when product_name like '%Lion Roar%' then 'Smoothie'
when product_name like '%Mint Baloon%' then 'Smoothie'
...
when product_name like '%Four Cousins Red%' then 'Sweet Red Wine'
...
when product_name like '%Declan Sparkling%' then 'Sparkling Wine'
...
when product_name like '%power horse%' then 'Energy Drink'
when product_name like '%wake%' then 'Energy Drink'

when product_name like '%curry%' then 'Sauce'

when product_name like '%grilled%' then 'Grills & Roasts'
...
when product_name like '%fish%' then 'Grills & Roasts'

when product_name like '%Goat Meat%' then 'Meat/Protein'
when product_name like '%beef%' then 'Meat/Protein'
when product_name like '%goat meat%' then 'Meat/Protein'
when product_name like '%snail%' then 'Meat/Protein'
when product_name like '%turkey%' then 'Meat/Protein'
when product_name like '%hot dog%' then 'Meat/Protein'
when product_name like '%chicken%' then 'Meat/Protein'
when product_name like '%asun%' then 'Meat/Protein'
when product_name like '%gizzdo%' then 'Meat/Protein'
when product_name like '%sauce%' then 'Meat/Protein'
when product_name like '%Gizzard%' then 'Meat/Protein'
when product_name like '%Peppered Crocer Fish%' then 'Meat/Protein'
...
when product_name like '%Seafood Paella%' then 'Seafood'
...
when product_name like '%Vegetable Soup%' then 'Soup'
when product_name like '%oha%' then 'Soup'
when product_name like '%okro%' then 'Soup'
when product_name like '%egusi%' then 'Soup'
when product_name like '%nsala%' then 'Soup'

when product_name like '%Cowtail%' then 'Native'
when product_name like '%Isi Ewu%' then 'Native'
when product_name like '%porridge%' then 'Native'
when product_name like '%nkwobi%' then 'Native'
when product_name like '%Vegetable goatmeat%' then 'Native'
when product_name like '%abacha%' then 'Native'
when product_name like '%Dry fish vegetable%' then 'Native'
when product_name like '%Fresh Fish Cut%' then 'Native'

when product_name like '%Croaker fish peppersoup%' then 'National Pepper Soup'
when product_name like '%Goatmeat peppersoup%' then 'National Pepper Soup'
...
when product_name like '%Roasted Yam%' then 'Finger Food'
when product_name like '%Boiled Yam%' then 'Finger Food'
...
when product_name like '%pound%' then 'Swallow'
...
when product_name like '%Oat Meal%' then 'Breakfast la Carte'
when product_name like '%English Breakfast%' then 'Breakfast la Carte'
when product_name like '%Cornflakes%' then 'Breakfast la Carte'

when product_name like '%salad%' then 'Salad'
when product_name like '%cosl%' then 'Salad'

when product_name like '%platter%' then 'Platter'
when product_name like '%face to face%' then 'Platter'

when product_name like '%pure haven%' then 'None Alcoholic Wine'
...
select * from new_order
where product_name like '%curry%'

select * from new_order
where product_name like '%milkshake%'
